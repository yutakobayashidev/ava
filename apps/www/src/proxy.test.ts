...
import { authMiddleware, rewriteMarkdownMiddleware } from "./proxy";
...
describe("proxy", () => {
  ...
  describe("authMiddleware", () => {
    ...
    it("should skip for /login path", async () => {
      const app = new Hono();
    ...
    it("should skip for /api path", async () => {
      const app = new Hono();
    ...
    it("should skip for /oauth path", async () => {
      const app = new Hono();
    ...
    it("should skip for /mcp path", async () => {
      const app = new Hono();
    ...
    it("should skip for /.well-known path", async () => {
      const app = new Hono();
    ...
    it("should allow authenticated user to access any paths", async () => {
      vi.spyOn(sessionLib, "validateSessionToken").mockResolvedValue({
        session: {
          id: "session-1",
          userId: "user-1",
