...
CREATE TYPE "public"."task_status" AS ENUM('in_progress', 'blocked', 'paused', 'completed');--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "task_pause_reports" (
	"id" text PRIMARY KEY NOT NULL,
	"task_session_id" text NOT NULL,
	"reason" text NOT NULL,
	"raw_context" jsonb DEFAULT '{}'::jsonb NOT NULL,
...
ALTER TABLE "task_pause_reports" ADD CONSTRAINT "task_pause_reports_task_session_id_task_sessions_id_fk" FOREIGN KEY ("task_session_id") REFERENCES "public"."task_sessions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "task_pause_reports_task_session_idx" ON "task_pause_reports" USING btree ("task_session_id");--> statement-breakpoint
